...
import GoldFish from "../assets/images/goldfish.png";
    ...
    <div className="relative h-[500px] pt-0 md:pt-24 ">
      <div className="h-[400px] mt-14 md:mt-24 ">
        ...
        <motion.img
          ...
          src={GoldFish}
          alt="hero_image"
          className="w-[50%] md:w-[40%] lg:w-[30%] absolute right-20 md:right-[15%] -bottom-16 md:-bottom-[12rem] select-none m-5 z-10"
        />
